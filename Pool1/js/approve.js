...
const POOL_ADDRESS = process.env.Pool; // Your pool contract address
...
async function main() {
  // Approve amounts
  const usdtApproveAmount = web3.utils.toWei("1000", "mwei"); // 1000 USDT (6 decimals)
  const otherTokenApproveAmount = web3.utils.toWei("1000", "mwei"); // 1000 TokenA or TokenB (18 decimals)
